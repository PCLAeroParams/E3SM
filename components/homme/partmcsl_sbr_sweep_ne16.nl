...
&ctl_nl
  ...
  nmax              = 384                    ! total number of dynamics steps (6 h / tstep)
  statefreq         = 200                       ! number of steps between screen dumps
  restartfreq       = -1                        ! don't write restart files if < 0
  runtype           = 0                         ! 0 = new run
  tstep             = 56.2500                   ! largest timestep in seconds
...
/
&analysis_nl
  output_dir        = "./movies_sbr_sweep_ne16/"            ! destination dir for netcdf file
